...
public record ContainerType(String name, String description) {
    ...
    public static ContainerType hasmatlocker = new ContainerType("Hazmat Locker", "This has a lengthy collection of identical hazmat suits and other lab wear. A sticky note reads '10p fine for not returning!'");
    public static ContainerType biohazardbox = new ContainerType("Biohazard Box", "A yellow box covered in all manner of warning signs. However, a sticky note tells you that it has now been decommissioned into a scientists lunchbox.");
